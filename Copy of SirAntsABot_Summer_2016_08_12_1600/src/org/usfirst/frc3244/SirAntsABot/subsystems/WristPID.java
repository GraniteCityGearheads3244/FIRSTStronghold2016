...
public class WristPID extends PIDSubsystem {
    ...
    /**
     * Increment Wrist +.5 Deg per Scan
     */
    public void my_Wrist_Jog_Up(){
    	Robot.wristPID.setSetpointRelative(.5);
    }
    
    /**
     * Decrement Wrist -.5 Deg per Scan
     */
    
    public void my_Wrist_Jog_Down(){
    	Robot.wristPID.setSetpointRelative(-.5);
    }
