...
public class ScissorPID extends PIDSubsystem {
    ...
    private final SpeedController motor = RobotMap.scissorPIDMotor;
    private final Encoder encoder = RobotMap.scissorPIDEncoder;
    private final DigitalInput limitSwitchStow = RobotMap.scissorPIDLimitSwitchStow;
