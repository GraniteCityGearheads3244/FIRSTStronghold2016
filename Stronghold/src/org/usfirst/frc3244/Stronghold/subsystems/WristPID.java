...
public class WristPID extends PIDSubsystem {
    ...
    private final AnalogPotentiometer wristAngle = RobotMap.wristPIDWristAngle;
    private final SpeedController motor = RobotMap.wristPIDMotor;
