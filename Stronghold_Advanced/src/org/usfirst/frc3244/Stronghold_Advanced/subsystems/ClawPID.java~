...
public class ClawPID extends PIDSubsystem {
    ...
    public void my_Claw_Jog_Open(){
    	Robot.clawPID.disable();
    	motor_Claw.set(.5);
    }
    
    public void my_Claw_Jog_Close(){
    	Robot.clawPID.disable();
    	motor_Claw.set(-.5);
    }
    
    public void my_Claw_Hold_Position(){
    	motor_Claw.set(0);
    	Robot.clawPID.setSetpoint(pot_Width.get());
    	Robot.clawPID.enable();
    }
    
    public void updateStatus(){
    	SmartDashboard.putNumber("Claw Width", pot_Width.get());
    }
}
