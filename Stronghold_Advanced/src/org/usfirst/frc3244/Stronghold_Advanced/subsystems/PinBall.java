...
public class PinBall extends Subsystem {
    ...
    private final DigitalInput limitSwitchPinballReset = RobotMap.pinBallLimitSwitchPinballReset;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    Counter counter = new Counter(limitSwitchPinballReset);
    ...
    public boolean my_PinballReady(){
    	return limitSwitchPinballReset.get();
    }
