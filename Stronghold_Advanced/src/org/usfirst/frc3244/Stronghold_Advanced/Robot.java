...
public class Robot extends IterativeRobot {
	...
	public static double VelocityLimit = .5;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        autoChooser.addObject("Option 1", new AutonomousCommand());
        autoChooser.addObject("Option 2", new AutonomousCommand());
        autoChooser.addObject("Option 3", new AutonomousCommand());
        autoChooser.addObject("Option 4", new AutonomousCommand());
        SmartDashboard.putData("Auto Chooser", autoChooser);
        
        SmartDashboard.putNumber("Velocity Limit", VelocityLimit);
    ...
    private void updateStatus(){
        clawPID.updateStatus();
        control.updateStatus();
        driveTrain.updateStatus();
        pinBall.updateStatus();
        scissorPID.updateStatus();
        seaLegs.updateStatus();
        wristPID.updateStatus();
    }
}
