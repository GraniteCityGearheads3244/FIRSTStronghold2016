 ...
 *
 */
public class  PIDDriveToDistance extends PIDCommand {

    public PIDDriveToDistance() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PID
        super("PIDDriveToDistance", 1.0, 0.0, 0.0, 0.02);
    ...
    protected void usePIDOutput(double output) {
        ...
        RobotMap.dummySpeedController1.pidWrite(output);
