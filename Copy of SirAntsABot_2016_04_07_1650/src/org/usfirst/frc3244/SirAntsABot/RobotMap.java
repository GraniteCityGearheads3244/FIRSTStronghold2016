...
public class RobotMap {
    ...
    public static final double SCISSOR_CLIMB_REACH_BAR = 73;//73;
    public static final double SCISSOR_CLIMB_LIFT_BOT =	42;
    public static final double SCISSOR_STOW_POS = 14;
