...
/*
    ...
    * 
    * 6/28/2016
    * 			1	Claw with 80 tooth gear PID needs Tuning 
    * 7/5/2016
    * 			1 	added timeout to Auto_ready_Ball and Auto_Cycle_Secure_Bal
    * 			2	OI.Java - Changed ScissorStartClimb.whileHeld to ScissorStartClimb.whenPresse
    */
...
public class Robot extends IterativeRobot {
	...
	private static final boolean START_GRIP = false;
